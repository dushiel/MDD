...
unionMain c !a_id !b_id = force_eval_debug (debug_manipulation (unionMain' c a_id b_id (getDd c a_id) (getDd c b_id))
    "union" "unionMain" c a_id b_id) "that was union main"
