...
MDD.hs: Core data types, Context Manager, and Node Hashing.

SODDmanipulation.hs: Implementation of apply', traverse_dc, catchup, and absorb.

SupportMDD.hs: Stack management, dc_stack manipulation, and static translation.

MDDi.hs: Interactive operators (.*., .+., neg) and high-level substitution logic.

Bool_MDD.hs: DSL for creating MDDs from Boolean formulas.
