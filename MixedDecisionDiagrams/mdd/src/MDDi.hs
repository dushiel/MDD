...
test = do
    ...
    where
        results =
            ...
            , ((p2 .*. p_2) .+. p2) == p2  `debug` ("############# Test nr: 23 \n\n")
            , ((p2 .*. p_2) .+. p_2) == p_2  `debug` ("############# Test nr: 24 \n\n")
            , ((p2 .+. p_2) .*. p2) == p2  `debug` ("############# Test nr: 25 \n\n")
            , ((p2 .+. p_2) .+. p_2) == (p2 .+. p_2)  `debug` ("############# Test nr: 26 \n\n")
            , ((p2 .*. p_2) .*. p2) == (p2 .*. p_2)  `debug` ("############# Test nr: 27 \n\n")
            , ((p2 .*. p_2) .+. p_2) == p_2  `debug` ("############# Test nr: 28 \n\n")

            --double domain exclusive s0 (29)
            , ((n'2 .*. n'_2) .+. n'2) == n'2  `debug` ("############# Test nr: 29 \n\n")
            , ((n'2 .*. n'_2) .+. n'_2) == n'_2  `debug` ("############# Test nr: 30 \n\n")
            , ((n'2 .+. n'_2) .*. n'2) == n'2  `debug` ("############# Test nr: 31 \n\n")
            , ((n'2 .+. n'_2) .+. n'_2) == (n'2 .+. n'_2)  `debug` ("############# Test nr: 32 \n\n")
            , ((n'2 .*. n'_2) .*. n'2) == (n'2 .*. n'_2)  `debug` ("############# Test nr: 33 \n\n")
            , ((n'2 .*. n'_2) .+. n'_2) == n'_2  `debug` ("############# Test nr: 34 \n\n")

            -- some triple domain cases (35)
            , ((n'_2 .*. n'__2).+. n'_2) == n'_2  `debug` ("############# Test nr: 35 \n\n")
            , ((p'_2 .*. p'__2).+. p'_2) == p'_2  `debug` ("############# Test nr: 36 \n\n")
            , ((p_2 .*. p__2).+. p_2) == p_2  `debug` ("############# Test nr: 37 \n\n")
            , ((n_2 .*. n__2).+. n_2) == n_2  `debug` ("############# Test nr: 38 \n\n")
            , (((n'_2 .*. n'__2) .*. n'3) .+. (n'__2 .*. n'3)) == (n'__2 .*. n'3)  `debug` ("############# Test nr: 39 \n\n")
            , (((p'_2 .*. p'__2) .*. p'3) .+. (p'__2 .*. p'3)) == (p'__2 .*. p'3)  `debug` ("############# Test nr: 40 \n\n")
            , (((p_2 .*. p__2) .*. p3) .+. (p__2 .*. p3)) == (p__2 .*. p3)  `debug` ("############# Test nr: 41 \n\n")
            , (((n_2 .*. n__2) .*. n3) .+. (n__2 .*. n3)) == (n__2 .*. n3)  `debug` ("############# Test nr: 42 \n\n")

            , (((n'_2 .+. n'__2) .+. n'3) .*. (n'__2 .+. n'3)) == (n'__2 .+. n'3)  `debug` ("############# Test nr: 43 \n\n")
            , (((p'_2 .+. p'__2) .+. p'3) .*. (p'__2 .+. p'3)) == (p'__2 .+. p'3)  `debug` ("############# Test nr: 44 \n\n")
            , (((p_2 .+. p__2) .+. p3) .*. (p__2 .+. p3)) == (p__2 .+. p3)  `debug` ("############# Test nr: 45 \n\n")
            , (((n_2 .+. n__2) .+. n3) .*. (n__2 .+. n3)) == (n__2 .+. n3)  `debug` ("############# Test nr: 46 \n\n")

            -- mixing all domains (48)
            , (((n'_2 .+. p'__2) .+. p3) .*. (p'__2 .+. p3)) == (p'__2 .+. p3)  `debug` ("############# Test nr: 47 \n\n")
            , ((dc2 .*. (dc3 .*. n3)) .+. (((n'_2 .*. p'__2) .+. p3) .*. (p'__2 .+. p3))) == ((dc2 .*. (dc3 .*. n3)) .+. ((n'_2 .*. p'__2) .+. p3))  `debug` ("############# Test nr: 48 \n\n")
            , ((n2 .*. (p'3 .*. dc3)) .+. (((p__2 .*. p'__2) .+. p3) .*. (n__2 .+. p3))) == ((n2 .*. (p'3 .*. dc3)) .+. ((p__2 .*. n__2) .+. p3))  `debug` ("############# Test nr: 49 \n\n")

            -- recursive
            , ((dcn1 .->. nn1) .+. (n'n1)) == top `debug4` ("############# Test nr: 50 \n\n")
            , (dcn1 .<-. nn1) == bot `debug4` ("############# Test nr: 51 \n\n")
            , (dcn1 .<-. n'n1) == top `debug4` ("############# Test nr: 52 \n\n")
            , (dcn1 .->. n'n1) == bot `debug4` ("############# Test nr: 53 \n\n")
