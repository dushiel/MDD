...
-- interpret variables as dont care, positive or negative literals. default = Dc1
-- Dc1 :: Infinite paths context, describing what continous section evaluates to True
-- Dc0 :: Infinite paths context, describing what continous section evaluates to False
-- Pos1 Finite paths context, describing what Positive variable evaluations evaluate to True
-- Pos0 Finite paths context, describing what Positive variable evaluations evaluate to False
-- Neg1 Finite paths context, describing what Negative variable evaluations evaluate to True
-- Neg0 Finite paths context, describing what Negative variable evaluations evaluate to False
...
-- | ================= Not sure yet what for / how it works ==================
...
--   bf' n = oneof [ pure Internal.Language.Top
--                 , pure Internal.Language.Bot
...
--                    , pure Bot
--                    , PrpF <$> arbitrary ]
--     form n = oneof [ pure Internal.Language.Top
--                    , pure Internal.Language.Bot
--                    , PrpF <$> arbitrary
--                    , Neg <$> form n'
--                    , Conj <$> listOf (form n')
