...
showTree'' c =  showTree'
    where
        ...
        showTree' f (InfNodes a dc n1 n0 (0, 0) p0) = ("<"++ f a ++ "> dc, n0, p1, p0)") : "  ║  " : concat (indentInfChildren [showTree' f (getDd c dc), showTree1' c f (getDd c n1), showTree0' c f (getDd c n0), showTree0' c f (getDd c p0)])
        showTree' f (InfNodes a dc n1 n0 p1 (0, 0)) = ("<"++ f a ++ "> dc, n0, p1, p0)") : "  ║  " : concat (indentInfChildren [showTree' f (getDd c dc), showTree1' c f (getDd c n1), showTree0' c f (getDd c n0), showTree1' c f (getDd c p1)])
